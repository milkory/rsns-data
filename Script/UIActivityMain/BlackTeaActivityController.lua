...
function Controller.RefreshServerStage()
  ...
  local ratio = string.format("%.3f", num / finalNum)
...
function Controller.RefreshBuffStage()
  ...
  buffView.Group_Bar.Group_Bar.Img_Slider.Img_Bar:SetFilledImgAmount(num / finalNum)
  ...
  buffView.Group_Bar.Group_Bar.StaticGrid_Buff.grid.self:SetDataCount(#buffDataModel.allBuffStage)
  buffView.Group_Bar.Group_Bar.StaticGrid_Buff.grid.self:RefreshAllElement()
